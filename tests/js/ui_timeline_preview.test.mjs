...
function testSectionPreviewUsesContainedRepeatedFrames() {
  ...
  assert.equal(rendererSource.includes("moveSection(timeline, this.drag.itemId, pointerTime - this.drag.pointerTimeOffset)"), true);
  ...
  assert.equal(rendererSource.includes("moveAudioClip(timeline, this.drag.itemId, pointerTime - this.drag.pointerTimeOffset)"), true);
